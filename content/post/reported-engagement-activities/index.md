...
The team maintains the [ARME website](https://arme-project.co.uk) and the [@ARMEproject](https://twitter.com/armeproject) social media channel to share news, demos, publications, and project activity.
...
ARME collaborated with the [Museum of Music History](https://momh.org.uk/event/seminar-augmented-reality-music-ensemble-arme/) for a seminar and live demonstration at Wolfson College, Oxford. The event presented the scientific and technical foundations of ARME, including virtual musicians, adaptive metronomes, and immersive rehearsal scenarios.

## University of Birmingham press coverage

The project has been covered by University of Birmingham press stories, including [Bringing the magic of playing music to the virtual world](https://www.birmingham.ac.uk/news/2024/bringing-the-magic-of-playing-music-to-the-virtual-world) and [Dr Massimiliano Di Luca leads development of software for virtual orchestra rehearsals](https://www.birmingham.ac.uk/news/2024/dr-massimiliano-di-luca-leads-development-of-software-for-virtual-orchestra-rehearsals).

## Hack the Midlands

ARME activity at [Hack the Midlands](https://hackthemidlands.com) involved a 24-hour hackathon setting and the collection of data from 50 participants, contributing to the project's wider research and prototyping work.
...
Through the University of Warwick [STEM Connections Initiative](https://warwick.ac.uk/fac/sci/wmg/about/outreach/stemconnections/), Max Di Luca and Mark Elliott contributed school-facing talks and a digital interview about the technologies and societal relevance of ARME.
